...
public class CitasCliPendientesControlador {
    ...
    @FXML
    private TableColumn<Cita, String> estado;
    ...
    private void cargarCitasPendientes() {
        ...
        String sql = "SELECT r.Cliente_ID, r.Perro_ID, p.Nombre AS perro, r.Hora, r.Fecha_cita, " +
                "r.Donacion, r.Estado, r.Fecha_alta, r.Fecha_modificacion " +
                "FROM Reservan r JOIN Perros p ON r.Perro_ID = p.ID " +
                "WHERE r.Cliente_ID = ? AND r.Fecha_cita > SYSDATE ORDER BY r.Fecha_cita";
